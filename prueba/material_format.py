...
class Ui_Dialog4(object):
    ...
    def save_material(self):
        self.data={"fabricante":self.maker.text(),"diametro":float(self.diameter_material.text()),
                   "costo_carrete":float(self.reel_cost.text()),"tamano_carrete":float(self.size_reel.text())
                   ,"densidad":float(self.density.text()),"temperatura_extrusor":float(self.extruder_temperature.text())
                   ,"temperatura_cama":float(self.bed_temperature.text())
        }
